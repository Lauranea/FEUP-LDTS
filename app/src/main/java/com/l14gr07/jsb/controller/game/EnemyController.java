...
public class EnemyController
{
    public void step(Enemy e)
    {
        if (e.get_position_x1() == e.get_position_x2())
        {
            ...
            {
                if ((e.get_position_y() > e.get_position_y2() && e.get_f()) || (e.get_position_y() < e.get_position_y2() && !e.get_f()))
                {
        ...
        else if (e.get_position_y1() == e.get_position_y2())
        {
            ...
            {
                if ((e.get_position_x() > e.get_position_x2() && e.get_f()) || (e.get_position_x() < e.get_position_x2() && !e.get_f()) )
                {
